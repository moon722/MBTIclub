...
public class PostResisterRequest extends StringRequest {
    //서버 URL설정(PHP 파일 연동)
    final static private String URL = "http://mbtiy.dothome.co.kr/PostRegister.php";
    private Map<String, String> map;


    public PostResisterRequest(String post_user_id, String board_title, String post_title, String post_content, Response.Listener<String> listener) {
